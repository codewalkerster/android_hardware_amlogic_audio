...
public:
    ...
    virtual audio_format_t GetDoblyConfigOutputFormat(void) { return mDolbyMS12OutFormat; }
    virtual int GetDolbyConfigOutputSampleRate(void) {return mDolbyMS12OutSampleRate; }
    virtual audio_channel_mask_t GetDolbyConfigOutputChannelMask(void) { return mDolbyMS12OutChannelMask; }
    ...
    virtual void setDRCboostVal(int val) { mDRCBoost = val; }
    virtual void setDRCcutVal(int val) { mDRCCut = val; }
    virtual void setDRCboostSystemVal(int val) { mDRCBoostSystem = val; }
    virtual void setDRCcutSystemVal(int val) { mDRCCutSystem = val; }
    ...
    virtual void setDAPV2InitialisationMode(int val) { mDAPInitMode = val; }// 0 or 1
    virtual void setDAPV2VirtualBassEnable(bool flag) { mDAPVirtualBassEnable = flag; }// 0 or 1
    virtual void setDRCMode(int val) { mDRCModesOfDownmixedOutput = val; }// 0 or 1
    virtual void setDAPDRCMode(int val) { mDAPDRCMode = val; }// 0 or 1
    virtual void setDownmixModes(int val) { mDonwmixMode = val; }// 0 or 1
    virtual void setEvalutionMode(int val) { mEvaluationMode = val; }// 0 or 1
    virtual void setLFEpresentInAPPSoundsIn(int val) { mLFEPresentInAppSoundIn = val; }// 0 or 1
    virtual void setLFEpresetInSystemSoundsIn(int val) { mLFEPresentInSystemSoundIn = val; }// 0 or 1
    virtual void setMaximumNumberofChannelsInTheSigalChain(int val) { mMaxChannels = val; }//6 or 8
    virtual void setDownmix71PCMto51OnMultiOutputs(int val) { mDonwnmix71PCMto51 = val; }//0 or 1
    virtual void setEncoderChannelModeLockingMode(int val) { mLockingChannelModeENC = val; }//0 or 1
    virtual void setRISCprecisionFlag(int val) { mRISCPrecisionFlag = val; }
    virtual void setDualmonoReproductionMode(int val) { mDualMonoReproMode = val; }
    ...
    virtual void setSystemAppAudioMixing(int val) { mSystemAPPAudioMixing = val; }
    virtual void setUserControlValuesForMixingMainAndAssociatedAudio(int val) { mUserControlVal = val; }
    ...
    //DDPLUS SWITCHES
    virtual void setDDPAssociatedSubstreamSelection(int val) { mDdplusAssocSubstream = val; }
    ...
    virtual void setLFEpresentInExternalPCMInput(int val) { mLFEPresentInExtPCMInput = val; }
    virtual void setPCMCompressorProfile(int val) { mCompressorProfile = val; }

    //HE-AAC SWITCHES
    virtual void setHEAACAsocciatedInstanceRestrictedTo2Channels(int val) { mAssocInstanse = val; }
    virtual void setHEAACDefaultDialnormValue(int val) { mDefDialnormVal = val; }
    virtual void setHEAACTransportFormat(int val) { mTransportFormat = val; }

    //DAP SWITCHES (device specific)
    virtual void setDAPCalibrationBoost(int val) { mDAPCalibrationBoost = val; }
    virtual void setDAPDownmixMode(int val) { mDAPDMX = val; }
    virtual void setDAPGains(int val) { mDAPGains = val; }
    virtual void setDAPSurroundDecoderEnable(bool val) { mDAPSurDecEnable = val; }
